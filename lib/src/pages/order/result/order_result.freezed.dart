...
class __$$SuccessImplCopyWithImpl<T, $Res>
    extends _$OrderResultCopyWithImpl<T, $Res, _$SuccessImpl<T>>
...
class _$SuccessImpl<T> implements Success<T> {
  ...
  @override
  String toString() {
    return 'OrderResult<$T>.success(sucess: $sucess)';
  }
...
abstract class Success<T> implements OrderResult<T> {
...
class _$ErrorImpl<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'OrderResult<$T>.error(message: $message)';
  }
